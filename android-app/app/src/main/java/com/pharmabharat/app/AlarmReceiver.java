        ...
        new Thread(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    try {
                        URL verUrl = new URL("https://pharmabharat-scraper-y2g3.onrender.com/api/app-version");
                    ...
                    try {
                        URL bcUrl = new URL("https://pharmabharat-scraper-y2g3.onrender.com/api/push-broadcast");
