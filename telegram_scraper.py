    ...
    try:
        ...
        for item in reversed(items):
            ...
            job_data = {
                ...
                "is_fresher": db.determine_fresher_eligibility(extra.get("experience_raw"), real_title, parsed.get("description_md")),
                "is_fresher_friendly": db.determine_fresher_eligibility(extra.get("experience_raw"), real_title, parsed.get("description_md")),
